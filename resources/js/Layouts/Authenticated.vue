            ...
            <nav class="bg-gray-800 border-b border-gray-800">
                    ...
                    <div class="flex  justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden  space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <breeze-nav-link :href="route('manajemen')" :active="route().current('manajemen')">
                                    Manajemen
                                </breeze-nav-link>
                            </div>
                        </div>
                        ...
                        <div class="-mr-2 flex items-center sm:hidden">
                            <button @click="showingNavigationDropdown = ! showingNavigationDropdown" class="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-blue-400 hover:bg-gray-900 focus:outline-none focus:bg-gray-900 focus:text-white transition duration-150 ease-in-out">
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <breeze-responsive-nav-link :href="route('manajemen')" :active="route().current('manajemen')">
                            Manajemen
                        </breeze-responsive-nav-link>
                    </div>
